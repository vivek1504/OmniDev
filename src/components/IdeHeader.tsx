    ...
    return (
        <div className="h-12 border-b border-border bg-sidebar flex items-center justify-between px-4 shrink-0">
            <div className="flex items-center gap-2">
                ...
                <span className="font-semibold text-sm tracking-tight text-foreground">OmniIDE</span>
            </div>

            <div className="flex bg-secondary/50 rounded-lg p-1 border border-border/50">
                <div className="px-3 py-1 text-xs font-medium text-foreground bg-background rounded-md shadow-sm">Code</div>
                <div className="px-3 py-1 text-xs font-medium text-muted-foreground hover:text-foreground cursor-pointer transition-colors">Design</div>
            </div>
